...
function loadSliderNews(div) {
    ...
    if (sliderNews.length) {
        if (sliderNews.hasClass('slick-initialized')) { sliderNews[0].slick.setPosition(); }
        // sliderNews.slick({
        //     slide: '.gSlide', adaptiveHeight: true, slidesToShow: 2,slidesToScroll: 2, arrows: true, dots: false, speed: 750, asNavFor: asNavFor
        // });
        else {
            sliderNews.slick({
                slide: '.gSlide', arrows: true, dots: false, slidesToShow: 2, slidesToScroll: 2, infinite: false, speed: 750,
                responsive: [
...
// Slider alertas
function loadSliderAlertas(div) {
    ...
    if (sliderAlerts.length) {
        if (sliderAlerts.hasClass('slick-initialized')) { sliderAlerts[0].slick.setPosition(); }
        else {
            sliderAlerts.slick({
                slide: '.gSlide', arrows: true, dots: false, slidesToShow: 2, slidesToScroll: 2, infinite: false, speed: 750,
                responsive: [
