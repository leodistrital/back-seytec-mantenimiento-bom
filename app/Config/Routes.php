...
$routes->group('api', ['namespace' => 'App\Controllers\API'], ['filter' => 'authFilter'], function ($routes) {
	...
	$routes->resource('tipo_sistema');
	$routes->resource('tipo_equipo');
	$routes->resource('equipos');
	$routes->resource('ubicacaciones');
	$routes->resource('unidadesmedida');
	// $routes->resource('item');
	$routes->resource('municipios');
	$routes->resource('agendamantenimiento');
...
/*
	...
	*/
	...
	// $routes->resource('agendatipo');
	// $routes->resource('agendalugares');
	// $routes->resource('agendaubicacion');
	// /* partametros agendas */
	// $routes->resource('agendamiento');
	// $routes->resource('detagendaparticioantes');
	// // $routes->get('agendamientoagenda', 'agendamiento::agendapersona');
	// // $routes->get('agendamientoagenda', 'agendamiento::agendapersona');
	// $routes->get('agendamientoagenda', 'Agendamiento::agendapersona');
	// $routes->get('agendamientoagendalista/(:any)', 'Agendamiento::agendamientoagendalista/$1');
	...
	$routes->group('parametros', ['namespace' => 'App\Controllers\API'], function ($routes) {
		...
		$routes->get('municipios', 'Municipios::parametros');
		$routes->get('tiposistema', 'Tipo_sistema::parametros');
		$routes->get('sede', 'Sedes::parametros');
		...
		// $routes->get('lugares', 'Agendalugares::parametros');
		// $routes->get('agendaubicacion', 'Agendaubicacion::parametros');
		// $routes->get('agendatipo', 'Agendatipo::parametros');
		// $routes->post('agendaubicacionvalidacion', 'Agendaubicacion::lugardisponible');
		// $routes->post('personadisponiblevalidacion', 'Agendaubicacion::personadisponible');
		// $routes->get('acreditadosagenda', 'Acr_registo::agendaacreditados');
...
$routes->group('panel', ['filter' => 'Panelsesion'], static function ($routes) {
	...
	$routes->get('agenda', 'Web\Panel::agenda');
