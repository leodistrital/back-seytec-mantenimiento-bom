                    ...
                    <fieldset>
                                ...
                                <p>
                                    <span class="label">
                                        <strong>Por favor, suba una foto tipo documento en formato jpg o
                                            png.<br>Recuerde evitar gafas de sol o sombreros que dificulte su identificación. Recuerde que la foto enviada en el registro se utilizará para su respectiva acreditación y guía de industria por lo que una vez enviada no podrá ser modificada.</strong>
                                        <br><em>Profile photo for accreditation. Please upload a document type photo, in
                                            jpg or png format. Remember to avoid sunglasses or hats that may hinder your identification. Remember that the photo sent in the registration will be used for your respective accreditation and industry guide, so once sent it cannot be modified.</em>
                                    </span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="gCol col2">
                            ...
                            <div>
                                <p>
                                    <span class="label">
                                        <strong>Por favor, adjunte documentos, contratos, certificaciones, créditos, entre otros, que permitan verificar su experiencia profesional de acuerdo a su actividad en un proyecto u obra relacionada con la industria audiovisual y/o cultural que haya sido publicada, emitida, circulada y/o distribuida en medios y/o espacios comerciales Nota: La hoja de vida NO es válida para certificar su experiencia.
                                        </strong>
                                        <br><em>Please attach documents, contracts, certifications, credits, among others, that allow verifying your professional experience according to your activity in a project or work related to the audiovisual and/or cultural industry that has been published, broadcasted, circulated and/or distributed in media and/or commercial spaces Note: The resume does not certify experience.</em>
                                    </span>
                                </p>
                            </div>
                        </div>
                        ...
                        <p></p>
                         ...
                         <div class="gCol col2">
                            <div>
                                <p>
                                    <label class="gLabel input required btnBAM">
                                        <span class="label static"><strong>Registro Único Tributario (RUT) <em> /  Or equivalent document</em></strong></span>
                            ...
                            <div>
                                <p>
                                    <span class="label">
                                        <strong>Por favor, adjunte el RUT con la información vigente o el documento equivalente de su país de origen.</strong>
                                        <br><em>Please attach the RUT with current information or the equivalent document from your country of origin.</em>
                                    </span>
                                </p>
                            </div>
                        </div>
