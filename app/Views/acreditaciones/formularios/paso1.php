            ...
            <section id="mainForm" class="contForm">
                <div class="gCenter">
                    ...
                    <fieldset>
                        ...
                        <div id="divubicacion" class="gCol col2">
                            <div>
                                <p>
                                    <label class="gLabel tSelect required">
                                        <span class="label"><strong>País de residencia<br><em> / Country of
                            ...
                            <input type="hidden" name="ciudadresidenciainput" id="ciudadresidenciainput"
                                value="<?= $datauser['ciudadresidencia'] ?>">
                            <input type="hidden" name="departamentoresidenciainput" id="departamentoresidenciainput"
                                value="<?= $datauser['depresidencia'] ?>">
                ...
                <div class="gCenter">
                    <div class="titleForm">
                        ...
                        <p class="noteRequired">Esta información es solicitada únicamente con fines estadísticos y no
                            será de dominio público.<br>
                            <br>
                            <em>
                                This information is requested for statistical purposes only and will not be in the
                                public domain.</em>
                        </p>
                    </div>
                    <fieldset>
                        ...
                        <div id="divetnia" class="gCol col2">
                            <div>
                                <p>
                                    <label class="gLabel required">
                                        <span class="label"><strong>Fecha de nacimiento<br><em> /
                            ...
                            <div>
                                <p>
                                    <label class="gLabel tSelect required">
                                        <span class="label"><strong>¿Pertenece a algún grupo étnico?<br><em> / Do you
                                                    belong
                                        ...
                                        <select name="grupoetnia" id="grupoetnia">
                                            ...
                                            <option value="2" <?= $datauser['grupoetnia'] == 2 ? 'selected' : ''; ?>>
                                                Afrocolombianos
                                                / Afro-descendants</option>

                                            <option value="5" <?= $datauser['grupoetnia'] == 5 ? 'selected' : ''; ?>>
                                                Raizales
                                            </option>
                                            ...
                                            <option value="6" <?= $datauser['grupoetnia'] == 6 ? 'selected' : ''; ?>>Otro
                                                / Other</option>
                            ...
                            <div>
                                <p id="otrogrupoetnico" style="display: none;">
                                    <label class="gLabel required">
                                        <span class="label"><strong>¿Cuál? <br><em> /
                                                    Which one?</em></strong></span>
                                        <input type="text" name="otrogrupoetnicotext" id="otrogrupoetnicotext"
                                            value=" <?= $datauser['grupoetniaotro'] ?>">
                                        <!-- otrogrupoetnicotext -->
                                    </label>
                                </p>
                            </div>
                                ...
                                <p id="plocalidades">
                                    <label class="gLabel tSelect">
                                        ...
                                        <select name="localidad" id="localidad">
                                            ...
                                            <option value="20" <?= $datauser['localidad'] == 2 ? 'selected' : ''; ?>>
                                                Santa Fe</option>
