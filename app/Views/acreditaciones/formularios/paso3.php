                    ...
                    <fieldset>
                        ...
                        <div class="gCol col2">
                            ...
                            <div>
                                <p>
                                    <label class="gCR">
                                        Distribución<em> / Distribution</em><input type="checkbox" name="actividad[]" id="actividad[]"
...
<div class="gCol col2">
                            <div>
                                <p>
                                    <label class="gCR">
                                        Exhibición-Circulación<em> / Exhibition-Circulation</em><input type="checkbox"
                                            name="actividad[]" id="actividad[]" value="20"
                                            <?= in_array(20, $actividad) ? 'checked' : '' ?>>
                                        <span class="icoC"></span>
                                    </label>
                                </p>
                            </div>
                        ...
                        <p>
                            <label class="gLabel required">
                                <span class="label"><strong>Página web de la empresa o red social principal  <em> / Company website or main social network</em></strong></span>
