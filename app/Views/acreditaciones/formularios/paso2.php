                    ...
                    <fieldset>
                        ...
                        <div class="gCol col2">
                            <div>
                                <p>
                                    <label class="gLabel tSelect required">
                                        <span class="label"><strong>Idioma<br><em> / Language</em></strong></span>
                            ...
                            <div>
                                <p>
                                    <label class="gLabel tSelect required">
                                        <span class="label"><strong>¿Participó en la edición 2023 de BAM Regiones?<br><em> / Did you participate in the 2023 edition of BAM Regiones?</em></strong></span>
                                ...
                                <p>
                                    <label class="gLabel tSelect required">
                                        ...
                                        <select name="sectoractividad" id="sectoractividad">
                                            ...
                                            <option value="30"
                                                <?= $datauser['sectoractividad'] == 30  ? 'selected' : ''; ?>>Distribuidor / Distributor
                                            </option>
                                            ...
                                            <option value="31"
                                                <?= $datauser['sectoractividad'] == 31  ? 'selected' : ''; ?>>Maquillista / Make-up</option>



                                            <option value="33"
                                                <?= $datauser['sectoractividad'] == 33  ? 'selected' : ''; ?>>Vestuarista / Artist-Custom designer</option>
                    ...
                    <fieldset>
                        ...
                        <div class="gCol col2">
                            ...
                            <div>
                                <p>
                                    <label class="gCR">
                                        Conseguir un Agente de ventas o distribuidor para un proyecto.<br><em>To find a sales agent or distributor for a project.</em> <input type="checkbox" name="intereses[]"
