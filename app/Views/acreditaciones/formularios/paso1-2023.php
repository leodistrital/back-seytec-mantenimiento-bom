            ...
            <section id="mainForm" class="contForm">
                <div class="gCenter">
                    <div class="titleForm">
                        ...
                        <p class="noteRequired">Esta información es solicitada únicamente con fines estadísticos y no será de dominio público.<br>
                            <br>
                            <em>
                                This information is requested for statistical purposes only and will not be in the public domain.</em>
                        </p>
                    </div>
                    <fieldset>
                        ...
                        <div id="divetnia" class="gCol col2">
                          ...
                          <div>
                                            <p>
                                                <label class="gLabel tSelect required">
                                                    <span class="label"><strong>¿Pertenece a algún grupo étnico?<br><em> / Do you belong
                                                    ...
                                                    <select name="grupoetnia" id="grupoetnia">
                                                        ...
                                                        <option value="2" <?=$datauser['grupoetnia'] == 2  ? 'selected' : '';?>>Afrocolombianos
                                                            / Afro-descendants</option>

                                                        <option value="5" <?=$datauser['grupoetnia'] == 5  ? 'selected' : '';?>>Raizales
                                                           </option>
                                    ...
                                    <div >
                                        <p id="otrogrupoetnico"  style="display: none;">
                                            <label class="gLabel required">
                                                ...
                                                <input type="text"  name="otrogrupoetnicotext"
                                                    id="otrogrupoetnicotext" 
                                                    value=" <?='xxx'?>"> 
                                                    <!-- otrogrupoetnicotext -->
                                            </label>
                                        </p>
