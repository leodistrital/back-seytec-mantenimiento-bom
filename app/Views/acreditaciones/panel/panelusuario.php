                                        ...
                                        <ul>
                                            ...
                                            <li class="cat2 acredBtn">
                                                <a href="<?= $ruta ?>" <?= $style ?> <?= $evento ?>>
                                                    <h2><?=traduccirlabeldb('ACREDITACIÓN'); ?><br>BAM 2024
                                                        <?= $activa ?></h2>
                                                </a>
                                            </li>

                                            <li class="cat2 acredBtn">
                                                <a href="/agenda1/<?=$codigoagenda?>">
                                            ...
                                            // echo $codigoagenda;
                                            // var_dump($activarpago);
                                          // $activarpago=true;
                                            if ($activarpago) {
                                                $valorAcreditacion = intval($datauserpago['val_tar']) * 100;
                                                $referenciaPago = $datauserpago['usu_reg'] . '-' . $random;
                                                $codigoIntegridad='prod_integrity_f5VQu3VfEGNw1YujecEXOApDWeFwppOm';    
                                                $firmadeintegridad=$referenciaPago.$valorAcreditacion.'COP'.$codigoIntegridad; 
                                                $firmadeintegridad=hash("sha256",$firmadeintegridad); 
                                            ?>
                                            ...
                                            <li class="cat2 acredBtn" style="background-color: #6f6eb3;">
                                                <form>
                                                    <script src="https://checkout.wompi.co/widget.js"
                                                        ...
                                                        data-signature:integrity="<?=$firmadeintegridad?>"
