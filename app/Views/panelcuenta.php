...
<section class="gMSection_interna">
    ...
    // echo $seccion;
    if ($seccion == 'agendapublica1') {
        // echo "view agenda";
        echo $this->include("agenda/panelagenda");
    }



    if ($seccion == 'agendapublica') {
        // echo "view agenda";
        echo $this->include("agenda/panelagendamiento");
    }
    if ($seccion == 'agendapublica2') {
        // echo "view agendazzzzzzz";
        echo $this->include("agenda/panelagendamiento2");
    }

    if ($seccion == 'agendatset') {
        // echo "view agenda";
        echo $this->include("agenda/panelagendatest");
    }
