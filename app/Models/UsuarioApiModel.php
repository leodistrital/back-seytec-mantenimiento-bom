...
class UsuarioApiModel extends Model
{
	...
	public function listatardatos($id = 0)
	{
		...
		// $hash ='$2y$10$GFarpZF99N6jwRo1QoNokuDBCdC7ixydM/XK6xStbe2qpYFGQNgA.';

		// if (password_verify('contenidoweb@rbsas.com', $hash)) {
	...
	public function guardar($request)
	{
		...
		$data = [
			'nom_usu' => 'administrador', 'log_usu' => 'contenidoweb@rbsas.com', 'pas_usu' => $userpass, 'cod_per_usu' => 1
	...
	public function edicion($id, $request)
	{
		$data = [
			'cod_usu' => $id,
			'nom_usu' => $request->getVar('nom_usu'), 'log_usu' => $request->getVar('log_usu'), 'pas_usu' => $request->getVar('pas_usu'), 'cod_per_usu' => $request->getVar('cod_per_usu')
