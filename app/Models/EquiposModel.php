...
class EquiposModel extends Model
{
	...
	protected $allowedFields        = ['nom_equ_esp' ,'nom_equ_ing' , 'obj_equ_esp', 'obj_equ_ing', 'fec_equ' , 'des_equ_esp' , 'des_equ_ing' , 'img_equ' , 'ord_equ'  , 'log_equ'];
...
public function listatardatos($id = 0)
	{
		...
		$array = ['cod_equ as id', 'nom_equ_esp' ,'nom_equ_ing' , 'obj_equ_esp', 'obj_equ_ing', 'fec_equ' , 'des_equ_esp' , 'des_equ_ing' , 'img_equ' , 'ord_equ' , 'log_equ' ];
