...
class ViewSitio
{
    ...
    public function getMenu1()
    {
        ...
        // echo "leonardo".get_cookie('bamidioma');
        $menu = new Menuprincipal();

        $array = ['nom_mep'];
        
        if (get_cookie('bamidioma') == "ENG") 
            $array = ['nom_mep_ing as  nom_mep' ];
        ...
        $array = ['slu_con', 'tit_con_esp'];
         ...
         if (get_cookie('bamidioma') == "ENG") 
            $array = ['slu_con', 'tit_con_ing as tit_con_esp'];
    ...
    public function getMenuConvocatorias($menuBloque)
    {
        ...
        if ($menuBloque['menu'] == 2) { // para traer solo un resultado para convocatoria
            ...
            $selesccionCategorias = $categoria->select($array)->where('edi_cat', $edicionActual)->orderby('ord_cat')->findAll();
    ...
    public function prensaAnterioes($menuid)
    {
        ...
        if (get_cookie('bamidioma') == "ENG") 
            $array = ['slu_con', 'tit_con_ing as nombre', 'men_con_ing as menu' ,'cod_con'];
