...
class Acr_registo extends ResourceController
{
    ...
    public function sendinblueenvio($correo, $nombre, $operacion, $opt = '')
    {
        ...
        if ($operacion == '2') { //aprobado
            $toName = $nombre;
            $toEmail = $correo;
            $subject = 'Confirmación Acreditación BAM 2024 / Accreditation confirmation BAM 2024';
            $envio = true;
        }
        ...
        if ($operacion == '4') { //rechazado
            $toName = $nombre;
            $toEmail = $correo;
            $subject = 'Acreditación no aprobada BAM 2024 / Accreditation not approved BAM 2024';
            $envio = true;
        }
   ...
   <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
               ...
               <tr>
                  ...
                  <td>
                     <h3 style="margin: 20px 0px 20px; font-size: 22px; line-height: 26px; letter-spacing: 1px; color: #6f6db5;">
                        Confirmación Acreditación BAM 2024<em><br>Accreditation confirmation BAM 2024</em>
                        </strong>
                     </h3>
                     <p style="margin: 0px; letter-spacing: 1px; font-size: 18px; line-height: 30px;">Saludos, '.$nombre.'<br><br> 
                        Luego de revisar cuidadosamente su solicitud de acreditación al BAM 2024, nos complace comunicarle que ha sido aprobada y será muy grato contar con usted en esta decimoquinta edición del Bogotá Audiovisual Market.<br><br>

                        Para finalizar el proceso, le pedimos cumplir con los siguientes requisitos: 
                        <br><br>
                        1. Proceder al pago de su acreditación a través de este link: <a href="bogotamarket.com" >bogotamarket.com</a> <br>
                        2. Enviar copia de pago de la transacción realizada a registration@bogotamarket.com<br><br>
                        Tenga un cuenta que sin el cumplimiento de estos dos requisitos, no será posible asegurar su acreditación al mercado. 
                     </p>
                     <h4>
                        <p style="margin: 80px 0px 0px; letter-spacing: 1px; font-size: 16px;">Cordialmente, <br />Equipo BAM </p>
                     </h4>
                  </td>
                  <td width="80">
                  </td>
               ...
               <tr>
                  ...
                  <td>
                     ...
                     <p style="margin: 0px; letter-spacing: 1px; font-size: 18px; line-height: 30px;">Greetings, '.$nombre.'<br>
                        <br> 
                      After carefully reviewing your application for accreditation to BAM 2024, we are pleased to inform you that it has been approved and it will be a pleasure to have you in this fifteenth edition of the Bogota Audiovisual Market.<br><br>
                        ...
                        2. Send a copy of the approved transaction to registration@bogotamarket.com.<br>
                        <br>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h3 style="margin: 20px 0px 20px; font-size: 22px; line-height: 26px; letter-spacing: 1px; color: #6f6db5;">
                                                Acreditación no aprobada BAM 2024	<em><br>Accreditation not approved BAM 2024</em>
                                                </strong>
                                            </h3>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h3 style="margin: 20px 0px 20px; font-size: 22px; line-height: 26px; letter-spacing: 1px; color: #6f6db5;">
                                                Confirmación Acreditación BAM 2024
                                                <em><br>Accreditation confirmation BAM 2024</em>
                                                </strong>
                                            </h3>
                                            <p style="margin: 0px; letter-spacing: 1px; font-size: 18px; line-height: 30px;">Saludos,<br><br> 
                                                Luego de revisar cuidadosamente su solicitud de acreditación al BAM 2024, nos complace comunicarle que ha sido aprobada y será muy grato contar con usted en esta decimoquinta edición del Bogotá Audiovisual Market.<br>
                                ...
                                <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <p style="margin: 0px; letter-spacing: 1px; font-size: 18px; line-height: 30px;">Greetings, <br><br>
                                                After carefully reviewing your application for accreditation to BAM 2024, we are pleased to inform you that it has been approved and it will be a pleasure to have you in this fifteenth edition of the Bogota Audiovisual Market<br>
    ...
    {
        $data = $this->model->agendaacreditados();
        return $this->respond($data, 200);
    }
