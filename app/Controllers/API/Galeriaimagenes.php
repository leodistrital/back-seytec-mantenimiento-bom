...
use App\Models\GaleriaimagenesApiModel;
use CodeIgniter\RESTful\ResourceController;

class Galeriaimagenes extends ResourceController
{
    protected $format    = 'json';

    public function __construct()
    {
        $this->modelName = new GaleriaimagenesApiModel();
    }
...
/* fecha de creacion: 11-12-2022 10:48:22 am */