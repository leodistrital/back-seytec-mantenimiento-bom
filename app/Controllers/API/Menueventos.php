...
use App\Models\MenueventosApiModel;
use CodeIgniter\RESTful\ResourceController;

class Menueventos extends ResourceController
{
    protected $format    = 'json';

    public function __construct()
    {
        $this->modelName = new MenueventosApiModel();
    }
...
/* fecha de creacion: 12-12-2022 11:46:45 am */