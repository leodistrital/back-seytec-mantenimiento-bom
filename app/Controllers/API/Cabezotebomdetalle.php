...
use App\Models\api\CabezotebomdetalleApiModel;
...
class Cabezotebomdetalle extends ResourceController
{
    ...
    {
        $this->modelName = new CabezotebomdetalleApiModel();
    }
    ...
    //  public function parametros($idapu = null)
    // {
...
/* fecha de creacion: 10-08-2025 01:54:23 pm */