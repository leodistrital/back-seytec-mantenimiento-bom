...
use App\Models\api\CapitulosbomApiModel;
...
class Capitulosbom extends ResourceController
{
    ...
    {
        $this->modelName = new CapitulosbomApiModel();
    }
    ...
    public function delete($id = null)
    {
      ...
      public function consultarapu($idapu = null)
    {
        $data = $this->model->consultarapu($idapu);
        return $this->respond($data, 200);
    }
...
/* fecha de creacion: 10-08-2025 02:07:13 pm */