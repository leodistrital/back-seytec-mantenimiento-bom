...
use App\Models\ComiteevaluadorApiModel;
use CodeIgniter\RESTful\ResourceController;

class Comiteevaluador extends ResourceController
{
    protected $format    = 'json';

    public function __construct()
    {
        $this->modelName = new ComiteevaluadorApiModel();
    }
...
/* fecha de creacion: 12-11-2022 11:58:34 pm */