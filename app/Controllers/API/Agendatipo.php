...
use App\Models\AgendatipoApiModel;
use CodeIgniter\RESTful\ResourceController;

class Agendatipo extends ResourceController
{
    protected $format = 'json';

    public function __construct()
    {
        $this->modelName = new AgendatipoApiModel();
    }
...
/* fecha de creacion: 05-29-2024 03:11:34 pm */