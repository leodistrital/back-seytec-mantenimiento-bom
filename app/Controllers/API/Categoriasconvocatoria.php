...
use App\Models\CategoriasconvocatoriaApiModel;
use CodeIgniter\RESTful\ResourceController;

class Categoriasconvocatoria extends ResourceController
{
    protected $format    = 'json';

    public function __construct()
    {
        $this->modelName = new CategoriasconvocatoriaApiModel();
    }
...
/* fecha de creacion: 12-11-2022 05:12:24 pm */