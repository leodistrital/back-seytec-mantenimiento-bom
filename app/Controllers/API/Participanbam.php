...
use App\Models\ParticipanbamApiModel;
use CodeIgniter\RESTful\ResourceController;

class Participanbam extends ResourceController
{
    protected $format    = 'json';

    public function __construct()
    {
        $this->modelName = new ParticipanbamApiModel();
    }
...
/* fecha de creacion: 01-16-2023 11:47:08 am */