...
use App\Models\AgendalugaresApiModel;
use CodeIgniter\RESTful\ResourceController;

class Agendalugares extends ResourceController
{
    protected $format = 'json';

    public function __construct()
    {
        $this->modelName = new AgendalugaresApiModel();
    }
...
/* fecha de creacion: 05-29-2024 02:35:09 pm */