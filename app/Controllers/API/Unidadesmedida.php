...
use App\Models\api\UnidadesmedidaApiModel;
use CodeIgniter\RESTful\ResourceController;

class Unidadesmedida extends ResourceController
{
    protected $format    = 'json';

    public function __construct()
    {
        $this->modelName = new UnidadesmedidaApiModel();
    }
...
/* fecha de creacion: 01-29-2025 04:59:01 pm */