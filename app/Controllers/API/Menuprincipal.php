...
use App\Models\MenuprincipalApiModel;
use CodeIgniter\RESTful\ResourceController;

class Menuprincipal extends ResourceController
{
    protected $format    = 'json';

    public function __construct()
    {
        $this->modelName = new MenuprincipalApiModel();
    }
...
/* fecha de creacion: 11-12-2022 10:49:08 am */