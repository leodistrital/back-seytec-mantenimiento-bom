...
use App\Models\RegionesbamApiModel;
use CodeIgniter\RESTful\ResourceController;

class Regionesbam extends ResourceController
{
    protected $format    = 'json';

    public function __construct()
    {
        $this->modelName = new RegionesbamApiModel();
    }
...
/* fecha de creacion: 01-16-2023 01:26:12 pm */