...
use App\Models\api\Tipo_sistemaApiModel;
use CodeIgniter\RESTful\ResourceController;

class Tipo_sistema extends ResourceController
{
    protected $format    = 'json';

    public function __construct()
    {
        $this->modelName = new Tipo_sistemaApiModel();
    }
...
/* fecha de creacion: 12-19-2024 04:19:48 pm */