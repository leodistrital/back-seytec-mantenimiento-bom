...
class Seleccionados extends  MyApiRest
{
    ...
    public function proyectos($edicion, $categoriaSlug)
    {
       ...
       // exit();
        ...
        $array = ['cod_cat', 'tit_cat as nom_cat', 'des_cat', 'fon_cat', 'eva_cat'];
        if (get_cookie('bamidioma') == "ENG") 
            $array = ['cod_cat', 'tit_cat_ing as nom_cat', 'des_cat_ing as des_cat', 'fon_cat', 'eva_cat'];
        ...
        $array = ['nom_coe', 'pai_coe', 'img_coe', 'per_coe'];
         if (get_cookie('bamidioma') == "ENG") 
            $array = ['nom_coe', 'pai_coe', 'img_coe', 'per_coe_ing as per_coe'];

       // print_r($contenidogocategoria);
      //  exit();
        ...
        if (get_cookie('bamidioma') == "ENG") 
            $array = ['cod_pro','cod_cat_pro', 'nom_pro_ing as nom_pro','per_pro','gen_pro','dur_pro','pdc_pro','sin_pro_ing as sin_pro','img_pro' , 'pdc_lin_pro'];
    ...
    public function resumenproyecto($proyecto)
    {
        ...
        if (get_cookie('bamidioma') == "ENG") 
            $array = ['cod_pro', 'nom_pro_ing as nom_pro', 'per_pro', 'gen_pro_ing as gen_pro', 'dur_pro', 'pdc_pro', 'con_pro', 'img_pro'];
    ...
    public function resumenpersona($perfil)
    {
        ...
        if (get_cookie('bamidioma') == "ENG") 
            $array = ['cod_pro', 'nom_pro_ing as nom_pro', 'per_pro', 'gen_pro_ing as gen_pro', 'dur_pro', 'pdc_pro', 'sin_pro_ing as sin_pro', 'img_pro'];
