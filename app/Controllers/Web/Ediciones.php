...
class Ediciones extends  MyApiRest
{
    ...
    public function contenidos($edicion = 0)
    {
        ...
        as programacion', 'gal_edi', "ad1_edi", "ad2_edi", "ad3_edi", "ad4_edi", "ad5_edi", "im1_edi",
         ...
         if (get_cookie('bamidioma') == "ENG") 
             $array = [
            'img_edi as imagen', 'tit_edi_ing as titulo', 'des_edi_ing as descripcion', 'sti_edi_ing as subtitulo', 'pro_edi
        as programacion', 'gal_edi', "ad1_edi", "ad2_edi", "ad3_edi", "ad4_edi", "ad5_edi", "im1_edi",
            "im2_edi", "im3_edi", "im4_edi", "im5_edi"
        ];
    ...
    public function seleccionados($categoria, $tipo)
    {
        ...
        if (get_cookie('bamidioma') == "ENG") 
            $array = ['cod_pro', 'nom_pro_ing as nom_pro', 'per_pro', 'gen_pro_ing as gen_pro', 'dur_pro', 'pdc_pro', 'sin_pro_ing as sin_pro', 'img_pro', 'pdc_lin_pro'];
